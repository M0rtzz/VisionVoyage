...
def main(input_images):
    ...
    FOV = 196  # 鱼眼视角
    output_path = '/home/m0rtzz/Workspaces/VisionVoyage/test/test.png'
    # 加载输入图像
    ...
    # 保存鱼眼图像
    cv2.imwrite(output_path, fisheye_picture)
...
if __name__ == '__main__':
    ...
    # output_path = '/home/m0rtzz/Workspaces/VisionVoyage/test'
