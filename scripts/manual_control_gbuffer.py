    ...
    def _parse_image(weak_self, image):
        ...
        if self.recording:
            if self.sensors[self.index][0].startswith('sensor.camera.rgb'):
                self.save_image(self.i_rgb, 'rgb', '.png', './assets/my_images/other_sensors/rgb/')
            elif self.sensors[self.index][0].startswith('sensor.camera.depth') and self.sensors[self.index][2].startswith('Camera Depth (Raw)'):
                self.save_image(self.i_depth_raw, 'depth_raw', '.png', './assets/my_images/other_sensors/depth_raw/')
                ...
                self.save_image(self.i_depth_gray_scale, 'depth_gray_scale',
                                '.png', './assets/my_images/other_sensors/depth_gray_scale/')
                ...
                self.save_image(self.i_semantic_segmentation_raw,
                                'semantic_segmentation_raw', '.png', './assets/my_images/other_sensors/semantic_segmentation_raw/')
                ...
                self.save_image(self.i_semantic_segmentation_cityscapes_palette,
                                'semantic_segmentation_cityscapes_palette', '.png', './assets/my_images/other_sensors/semantic_segmentation_cityscapes_palette/')
                ...
                self.save_image(self.i_instance_segmentation, 'instance_segmentation',
                                '.png', './assets/my_images/other_sensors/instance_segmentation/')
            elif self.sensors[self.index][0].startswith('sensor.camera.dvs'):
                self.save_image(self.i_dvs, 'dvs', '.png', './assets/my_images/other_sensors/dvs/')
            elif self.sensors[self.index][0].startswith('sensor.camera.optical_flow'):
                ...
                self.save_image(self.i_optical_flow, 'optical_flow', '.png',
                                './assets/my_images/other_sensors/optical_flow/')
            elif self.sensors[self.index][0].startswith('sensor.camera.normals'):
                self.save_image(self.i_normals, 'normals', '.png', './assets/my_images/other_sensors/normals/')
            elif self.sensors[self.index][0].startswith('sensor.lidar.ray_cast'):
                # image.save_to_disk('_out/%08d' % image.frame)
                image.save_to_disk(f"./assets/my_images/other_sensors/lidar_ray_cast/{image.frame:06d}_lidar_ray_cast")
                self.rename_files("./assets/my_images/other_sensors/lidar_ray_cast")
