...
class HUD(object):
    ...
    def __init__(self, width, height):
        ...
        self.dim = (width, height)
        # 使用本地黑体字体文件创建字体对象
        font_path = '/home/m0rtzz/Workspaces/Tongyong_ws/saved/fonts/simhei.ttf'
        font_size = 20
    ...
    def tick(self, world, clock):
        ...
        self._info_text = [
            ...
            u'朝向:% 16.0f\N{DEGREE SIGN} % 2s' % (transform.rotation.yaw, heading),
            '位置:% 20s' % ('(% 5.1f, % 5.1f)' % (transform.location.x, transform.location.y)),
            # 'GNSS:% 24s' % ('(% 2.6f, % 3.6f)' % (world.gnss_sensor.lat, world.gnss_sensor.lon)),
            # 'Height:  % 18.0f m' % transform.location.z,
            '']
        # if isinstance(control, carla.VehicleControl):
        #     self._info_text += [('Throttle:', control.throttle, 0.0, 1.0),
        ...
        #                             -1: 'R',
        #                             0: 'N'
        #     }.get(control.gear, control.gear)]
        if isinstance(control, carla.VehicleControl):
            self._info_text += [('油门:', control.throttle, 0.0, 1.0),
                                ('轮胎方向:', control.steer, -1.0, 1.0),
        ...
        # self._info_text += [('Speed:', control.speed, 0.0, 5.556),
        #                     ('Jump:', control.jump)]
        # self._info_text += [
        #     '', 'Collision:', collision, '',
        ...
        vehicles = [(dist(x.get_location()), x) for x in vehicles
            ...
            for item in self._info_text:
                ...
                if isinstance(item, list):
                    ...
                    if isinstance(item[1], bool):
                        ...
                        if item[2] < 0.0:
                            rect = pygame.Rect((bar_h_offset + fig *
