...
normal_config_path = '/home/m0rtzz/Workspaces/mmsegmentation-v1.2.2/configs/mask2former/mask2former_swin-t_8xb2-90k_cityscapes-512x1024.py'
normal_checkpoint_path = 'scripts/models/normal.pth'

fisheye_config_path = 'scripts/configs/mask2former/CBAM4_swin-t_fisheye-mean.py'
fisheye_checkpoint_path = 'scripts/models/fisheye.pth'
...
def assignConfigByResolution(img_path):
    ...
    default_paths = ('default_config', 'default_checkpoint', 'default_output')
