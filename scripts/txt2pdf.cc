...
bool fromTextDocumentToPDF(const string &input_file_path, const string &output_pdf_path)
{
    ...
    // 设置字体并创建新页面
    const char *load_simhei = HPDF_LoadTTFontFromFile(pdf, "/home/m0rtzz/Desktop/Code/test_txt2pdf/fonts/simhei.ttf", HPDF_TRUE);
    const char *load_fira_code = HPDF_LoadTTFontFromFile(pdf, "/home/m0rtzz/Desktop/Code/test_txt2pdf/fonts/FiraCode-Medium.ttf", HPDF_TRUE);
