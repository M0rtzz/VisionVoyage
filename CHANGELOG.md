...
* 📝 docs(CHANGELOG.md): automatic update ([5682a83](https://github.com/M0rtzz/VisionVoyage/commit/5682a83))



## 8.6.0-stable (2024-08-12)

* ✨ feat: add code to get repo root dir ([01e6f7a](https://github.com/M0rtzz/VisionVoyage/commit/01e6f7a))
* ✨ feat: add code to get repo root dir ([d5a7a52](https://github.com/M0rtzz/VisionVoyage/commit/d5a7a52))
* ✨ feat: update script to start VisionVoyage_Server ([2bc346c](https://github.com/M0rtzz/VisionVoyage/commit/2bc346c))
* 🐛 fix(alipay.py): fix the ssl bug ([fa2dae0](https://github.com/M0rtzz/VisionVoyage/commit/fa2dae0))
* 💄 ui: update version display ([7638952](https://github.com/M0rtzz/VisionVoyage/commit/7638952))
* 📝 docs: add docs for downloading datasets ([4254dbb](https://github.com/M0rtzz/VisionVoyage/commit/4254dbb))
* 📝 docs(GET_STARTED.md): add content for downloading datasets ([8370ba0](https://github.com/M0rtzz/VisionVoyage/commit/8370ba0))
* 📝 docs(README.md): add README.md ([80abdf2](https://github.com/M0rtzz/VisionVoyage/commit/80abdf2))
* 📝 docs(README.md): add README.md ([1a51c94](https://github.com/M0rtzz/VisionVoyage/commit/1a51c94))
* 🔨 script(setup.sh): update echo info and rm unused func ([4f2958b](https://github.com/M0rtzz/VisionVoyage/commit/4f2958b))
* 🙈 ignore(.gitignore): add datasets ([1df30b0](https://github.com/M0rtzz/VisionVoyage/commit/1df30b0))
* 🙈 ignore(.gitignore): add some file ([e45b6b4](https://github.com/M0rtzz/VisionVoyage/commit/e45b6b4))
* 🙈 ignore(.gitignore): update .gitignore ([0f34980](https://github.com/M0rtzz/VisionVoyage/commit/0f34980))
* 🙈 ignore(.gitignore): update .gitignore ([ef9b614](https://github.com/M0rtzz/VisionVoyage/commit/ef9b614))
* 🙈 ignore(.gitignore): update .gitignore ([d4a7c1f](https://github.com/M0rtzz/VisionVoyage/commit/d4a7c1f))
* 🚚 move: rename dir ([194fc6f](https://github.com/M0rtzz/VisionVoyage/commit/194fc6f))
* 🚚 move: rename dir ([e29fae8](https://github.com/M0rtzz/VisionVoyage/commit/e29fae8))
* 🚚 move: rename file ([7bdca62](https://github.com/M0rtzz/VisionVoyage/commit/7bdca62))
...
* 🔧 config(resources.qrc): update resource config file ([f9fd64d](https://github.com/M0rtzz/VisionVoyage/commit/f9fd64d))
...
* 🧵 thread(main.sh): only allow single process access ([de1d323](https://github.com/M0rtzz/VisionVoyage/commit/de1d323))
...
* add doc for Downloading demo video ([cb843bd](https://github.com/M0rtzz/VisionVoyage/commit/cb843bd))
...
* ddd support for multiple cloud storages ([0de4f38](https://github.com/M0rtzz/VisionVoyage/commit/0de4f38))
...
* add logic of pressing btn_raw_to_platte ([a52b9bb](https://github.com/M0rtzz/VisionVoyage/commit/a52b9bb))
